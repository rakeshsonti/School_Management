...
<div class='module'>
<script type="text/javascript" src="/<%=ApplicationSettings.ContextName%>/js/StudentEditForm.js"></script>
...
<h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Student (Edit Module)</h3>
<jsp:getProperty name='errorBean' property='error' />
<form action='/<%=ApplicationSettings.ContextName%>/EditStudent.jsp' onsubmit='return validateForm(this)'>
<center>
<table>
<tr>
<td>

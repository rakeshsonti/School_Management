...
import java.util.*;
public class GreaterThanEqualsTagHandler extends TagSupport
{
private Object leftOperand;
private Object rightOperand;
public GreaterThanEqualsTagHandler()
{
reset();
}
public void reset()
...
{ 
if(this.leftOperand instanceof Comparable==false || this.rightOperand instanceof Comparable==false)
return SKIP_BODY;
Comparable leftOperand=(Comparable)this.leftOperand;
Comparable rightOperand=(Comparable)this.rightOperand;

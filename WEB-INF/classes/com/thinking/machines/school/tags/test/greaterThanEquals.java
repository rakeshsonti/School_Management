...
int greaterThanEqual(Comparable leftOperand,Comparable rightOperand)
{
...
if(leftClassName.equals("java.lang.Boolean") || rightClassName.equals("java.lang.Boolean")) return SKIP_BODY;
...
greaterThanEquals a=new greaterThanEquals();
System.out.println(oo[a.greaterThanEqual(false,true)]);
System.out.println(oo[a.greaterThanEqual(true,true)]);
System.out.println(oo[a.greaterThanEqual("10","10")]);
System.out.println(oo[a.greaterThanEqual("10","20")]);
System.out.println(oo[a.greaterThanEqual(10,"5")]);
System.out.println(oo[a.greaterThanEqual("10",20)]);
// Write many more
}

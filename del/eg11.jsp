...
<table border='0'>
<tr><td>
RollNumber&nbsp;&nbsp;&nbsp;&nbsp;<input type='text' name='rollNumber' id='rollNumber' value='${studentBean.rollNumber}'>
<span id='rollNumberErrorSection'></span>
</td></tr>
<tr><td>
Name&nbsp;&nbsp;&nbsp;&nbsp;<input type='text' name='name' id='name' value='${studentBean.name}'>
...
<tr><td>
Date of Birth&nbsp;&nbsp;&nbsp;&nbsp;<input type='text' name='dateOfBirth' id='dateOfBirth' value='${studentBean.dateOfBirth}'>
...
Indian<input type='checkbox' name='isIndian' id='isIndian' checked>
<span id='isIndianErrorSection'></span>
</tm:Equals>
<tm:NotEquals leftOperand="on" rightOperand="${studentBean.isIndian}">
Indian&nbsp;&nbsp;&nbsp;&nbsp;<input type='checkbox' name='isIndian' id='isIndian'>
<span id='isIndianErrorSection'></span>
</tm:NotEquals>
</td></tr>
<tr><td>
Select city&nbsp;&nbsp;&nbsp;&nbsp;<select name='cityCode' id='cityCode'>

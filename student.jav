...
<form action='/<%=ApplicationSettings.ContextName%>/addStudent' onsubmit='return validateForm(this)' class='addForm'>
<table>
<tr>
<td>
Roll Number
...
<tm:NotEquals leftOperand='${studentBean.rollNumber}' rightOperand='0'>
<input type=text name='rollNumber' id='rollNumber' value='${studentBean.rollNumber}'>
</tm:NotEquals>
<span id='rollNumberErroSection' class='error'></span>
</td>
</tr>
<tr>
<td>
...
<td>
<input type='text' name='mobileNumber' id='mobileNumber' value='${studentBean.name}'>
...
<span id='subjectGroupErrorSecction' class='error'></span>
</td>
</tr>
<tr>
